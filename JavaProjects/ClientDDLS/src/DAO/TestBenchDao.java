...
public class TestBenchDao {
	...
	/*public boolean verify(String registryAdmin) {
		...
		try {
			...
			System.out.println("- ERRO AO BUSCAR NA TABELA TESTBENCH_TB!!\n\n");
			throw new RuntimeException(e.getMessage());
		}
	}*/

	public void save(TestBench tb) {
		String sql = "INSERT INTO testbench_tb (testbId, referenceFiles, testbDateUp, registryAdmin) VALUES (?,?,now(),?);";
